...
namespace buttonGUI {
	...
	*/
	...
	{
	public:
		buttonEvent(buttonAction a, int id, button * mainButton, button * dragDroppedButton = NULL, Ogre::UTFString data = "") :
			action(a),
			mouseButton(id),
	...
	public:
		...
		button(const std::string &buttonName, const std::string &material, const buttonPosition &position, short width, short height, buttonManager * mgr, Ogre::Overlay * o, button * parentButton, textScheme &style, bool isActiveButton);
		~button();
		...
		*/
		button * createChildButton(std::string name, std::string material, const buttonPosition &position, short  width, short  height, bool isActiveButton = true);
		button * createChildButton(std::string name, std::string material, const buttonPosition &position, short  width, short  height, textScheme &scheme, bool isActiveButton = true);
		...
		*/
		button *  addTextArea(std::string name, Ogre::UTFString value, short posX, short posY, Ogre::TextAreaOverlayElement::Alignment a = Ogre::TextAreaOverlayElement::Center);
		...
		*/
		textInputArea * createTextInputArea(std::string textInputName, Ogre::TextAreaOverlayElement::Alignment a, buttonPosition &position, short width, short height, short textPosX, short textPosY, bool isActiveButton = true);
		textInputArea * createTextInputArea(std::string textInputName, Ogre::TextAreaOverlayElement::Alignment a, std::string material, buttonPosition &position, short width, short height, short textPosX, short textPosY, bool isActiveButton = true);
		textInputArea * createTextInputArea(std::string textInputName, Ogre::TextAreaOverlayElement::Alignment a, std::string material, buttonPosition &position, short width, short height, short textPosX, short textPosY, textScheme &style, bool isActiveButton = true);
	...
	public:
		textInputArea(buttonManager * mgr, std::string &textInputName, Ogre::TextAreaOverlayElement::Alignment a, std::string &material, buttonPosition &position, button * parentButton, short width, short height, short textPosX, short textPosY, textScheme &style, bool isActiveButton);
		~textInputArea();
	...
	public:
		...
		*
		*/
		button* createButton(std::string name, std::string material, const buttonPosition &position, unsigned short width, unsigned short height, unsigned short zOrder = 0, bool visible = true, bool isActive = true);
		button* createButton(std::string name, std::string material, const buttonPosition &position, unsigned short width, unsigned short height, textScheme &scheme, unsigned short zOrder = 0, bool visible = true, bool isActive = true);
		...
		*/
		void forceClick(const int mouseButton = 0);
		...
		*/
		void forceClickButton(button *b, const int mouseButton = 0);
		void forceClickButton(std::string buttonName, const int mouseButton = 0);
		...
		*/
		...
		void getCursorPosition(int &x, int &y) { x = mouseX; y = mouseY; }
	...
	private:
		...
		int turningMouseButton; // this is the mouse button that can rotate buttonMeshes.
